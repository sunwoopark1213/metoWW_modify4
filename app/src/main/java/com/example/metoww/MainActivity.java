...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnOpenAirQuality = findViewById(R.id.btnOpenAirQuality);
        btnPollenForecast = findViewById(R.id.btnPollenForecast);
...
//        tvCityName.setText("Seoul");
    ...
    private void openPollenForecastActivity() {
        Intent intent = new Intent(MainActivity.this, PollenForecastActivity.class);
        startActivity(intent);
    }
